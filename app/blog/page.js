    ...
    <div className="min-h-screen bg-[#020617] text-slate-200 font-sans selection:bg-purple-500/30">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <header className="mb-16">
          ...
          <p className="text-xl text-slate-400 max-w-3xl">Thoughts on technology, development, and the future of web. I share what I learn working with clients worldwide.</p>
        </header>
