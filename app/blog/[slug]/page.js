      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <article className="prose prose-invert prose-lg max-w-none">
          ...
          <div className="not-prose bg-purple-900/20 p-8 rounded-3xl border border-purple-500/30 text-center">
            ...
            <p className="text-slate-300 mb-6">We'd love to discuss how we can help you with your project.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact" className="bg-purple-600 text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-[0.3em] hover:bg-purple-500 transition shadow-xl">
                Contact Us
              </Link>
              <a href="https://wa.me/6283841632837" target="_blank" className="bg-white/10 text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-[0.3em] hover:bg-white/20 transition">
                WhatsApp
              </a>
            </div>
          </div>
